...
window.addEventListener('load', (e) => {
    ...
    const imgLink1 = createImageElement(`https://developer1.pythonanywhere.com/${data.img1}`);
    mediaContainer.appendChild(imgLink1);

    if (data.image2 !== null) {
        const imgLink2 = createImageElement(`https://developer1.pythonanywhere.com/${data.img2}`);
        mediaContainer.appendChild(imgLink2);
    }

    if (data.image3 !== null) {
        const imgLink3 = createImageElement(`https://developer1.pythonanywhere.com/${data.img3}`);
