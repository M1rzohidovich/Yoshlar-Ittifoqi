...
const listContainer = document.getElementById('partner_list');
fetch('https://developer1.pythonanywhere.com/main/get-partner')
  ...
  listContainer.addEventListener('click', (e) => {
    fetch(`https://developer1.pythonanywhere.com/main/get-partner/${e.target.id}`)
        .then(response => response.json())
        .then(data => {
            console.log(data);
            ...
            if (data) {
                ...
                localStorage.setItem('Data_partners', JSON.stringify(data));
...
function waitForData() {
    ...
    if (data) {
        window.location = 'hamkorlar_item.html';
    } else {
