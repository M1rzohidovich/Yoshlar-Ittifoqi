...
const listContainer = document.getElementById('imtiyozlar_list');
fetch('https://developer1.pythonanywhere.com/main/get-privileges')
  ...
  listContainer.addEventListener('click', (e) => {
    fetch(`https://developer1.pythonanywhere.com/main/get-privileges/${e.target.id}`)
        .then(response => response.json())
        .then(data => {
            console.log(data);
            ...
            if (data) {
                ...
                localStorage.setItem('Data_privilages', JSON.stringify(data));
...
function waitForData() {
    ...
    if (data) {
        window.location = 'imtiyoz_item.html';
    } else {
